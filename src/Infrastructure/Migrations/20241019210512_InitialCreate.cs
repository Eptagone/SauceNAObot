...
public partial class InitialCreate : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey(
                    "PK_SauceSauceMedia",
                    x => new { x.AssociatedMediasId, x.SaucesId }
                );
                table.ForeignKey(
    ...
    {
        migrationBuilder.DropTable(name: "AntiCheatRestrictions");

        migrationBuilder.DropTable(name: "ApiKeys");

        migrationBuilder.DropTable(name: "SauceSauceMedia");
        ...
        migrationBuilder.DropTable(name: "SearchedMedias");
